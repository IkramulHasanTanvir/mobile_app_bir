                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: GetBuilder<ProductDetailsImageController>(
                          builder: (productDetailsImageController) {
                        return PageView.builder(
                          itemCount: widget.product.images.length,
                          controller: _pageController,
                          onPageChanged:
                              productDetailsImageController.changePage,
                                  ...
                                  builder: (BuildContext context) {
                                    return Dialog(
                                      ...
                                      child: Container(
                                        ...
                                        height: size.height * 0.17,
                                        // Adjusts height based on the screen size
                                        child: CardImage(
                                          onTapFavourite: () {},
                      ...
                      child: Column(
                        children: [
                          ...
                          ProductDetailsView(
                            ...
                            subCategory:
                                'Sub-Category: ${widget.product.subCategory ?? 'Unknown'}',
                            details: widget.product.description ??
                                'No details available.',
                            reviews: widget.product.reviews?.toString() ?? '0',
                            reviewsPoint:
                                widget.product.reviewsPoint?.toString() ??
                                    '0.0',
